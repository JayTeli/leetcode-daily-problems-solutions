...
|-------|:-----:|:-----:|--------|
|03/09/2024 | [1945. Sum of Digits of String After Convert]([https://leetcode.com/problems/remove-k-digits/](https://leetcode.com/problems/sum-of-digits-of-string-after-convert/description)) | [Java](https://github.com/JayTeli/leetcode-daily-problems-solutions/blob/master/src/java/1945._Sum_of_Digits_of_String_After_Convert.java)) | Count directly instead of doing string concat first and later looping & adding digits |
