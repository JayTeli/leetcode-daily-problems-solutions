...
|-------|:-----:|:-----:|--------|
|11/02/2022 | [567. Permutation in String](https://leetcode.com/problems/permutation-in-string/) | [Java](https://github.com/JayTeli/leetcode-daily-problems-solutions/blob/master/src/java/567._Permutation_in_String.java) | Using extra array , p(s1) is substring of s2 if some substring in s2 contains same charFreq as charFreq of s1. Using Sliding window , keep track of noOfCharsWithSameFreq in window and when window moves update noOfCharsWithSameFreq based on char removed and added using left and right pointer.|  
