...
|-------|:-----:|:-----:|--------|
|03/09/2024 | [1945. Sum of Digits of String After Convert]([https://leetcode.com/problems/remove-k-digits/](https://leetcode.com/problems/sum-of-digits-of-string-after-convert/description)) | [Java]([https://github.com/JayTeli/leetcode-daily-problems-solutions/blob/master/src/java/402._Remove_K_Digits.java](https://github.com/JayTeli/leetcode-daily-problems-solutions/blob/master/src/java/1945._Sum_of_Digits_of_String_After_Convert.java)) | Count directly instead of doing string concat first and later looping & adding digits |
...
|11/02/2022 | [567. Permutation in String](https://leetcode.com/problems/permutation-in-string/) | [Java](https://github.com/JayTeli/leetcode-daily-problems-solutions/blob/master/src/java/567._Permutation_in_String.java) | Array : permutation(s1) is substring of s2 if some substring in s2 contains same charFreq as charFreq of s1. Sliding window : for window , track noOfCharsWithSameFreq & update it on window movement using left and right ptrs |  
...
| Tree | [Kth Smallest Element in a BST](https://leetcode.com/problems/kth-smallest-element-in-a-bst/) | [Java](https://github.com/JayTeli/leetcode-daily-problems-solutions/blob/master/src/java/230._Kth_Smallest_Element_in_a_BST.java) | Recursive and Iterative Inorder|
| Tree | [Lowest Common Ancestor of BST](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/) | ComingSoon | |
| Tree | [Implement Trie (Prefix Tree)](https://leetcode.com/problems/implement-trie-prefix-tree/) | [Java](https://github.com/JayTeli/leetcode-daily-problems-solutions/blob/master/src/java/208._Implement_Trie_(Prefix_Tree).java) | TrieNode class with properties links , maxChildren , isEnd and functns get() , put() , containsKey() , isEnd() , setEnd(). While inserting , iterate char by char and for missing word add new node , get node for each char and for last node set isEnd true. In startsWith , search for lastNode after iterating for each char in word , if keys exists for all char , lastNode will be nonNull. In search , startsWith full string and for last node isEnd shud be true. |
...
| Array | [169. Majority Element](https://leetcode.com/problems/majority-element/) | [Java](https://github.com/JayTeli/leetcode-daily-problems-solutions/blob/master/src/java/169._Majority_Element.java) | Boyer-Moore Voting Algorithm : when 0 , set candidate. else +1 when found and -1 for others.|
...
| Tree | [208. Implement Trie (Prefix Tree)](https://leetcode.com/problems/implement-trie-prefix-tree/) | [Java](https://github.com/JayTeli/leetcode-daily-problems-solutions/blob/master/src/java/208._Implement_Trie_(Prefix_Tree).java) | TrieNode class with properties links , maxChildren , isEnd and functns get() , put() , containsKey() , isEnd() , setEnd(). While inserting , iterate char by char and for missing word add new node , get node for each char and for last node set isEnd true. In startsWith , search for lastNode after iterating for each char in word , if keys exists for all char , lastNode will be nonNull. In search , startsWith full string and for last node isEnd shud be true. |
